          ...
          <ul class="nav navbar-nav">
            <li class="dropdown user user-menu">
              ...
              ?>
                ...
                {
              ?>
                <img src="logo/<?php echo $row_data2['foto'];?>" class="img-circle" style="height: 20px;width: 20px"
                  alt="User Image">
                <?php
                }
              ?>
              ...
              ?>
                ...
                {
              ?>
                  <img src="logo/<?php echo $row_data2['foto'];?>" class="img-circle" style="height: 100px;width: 100"
                    alt="User Image">
                  <?php
                }
              ?>
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="index.php?controller=sistem&method=logout" onClick="return confirm('Yakin Mau Keluar??')"
        ...
        <div class="user-panel">
          <div class="pull-left image">
            ...
            <?php
                ...
                {
              ?>
            <img src="logo/<?php echo $row_data2['foto'];?>" style="height: 50px;width: 50px;" class="img-circle"
              alt="User Image">
            <?php
                }
              ?>
