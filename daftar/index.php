      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Sistem Informasi Kenaikan Pangkat, Kenaikan Gaji Berkala dan Arsip Kepegawaian <?php echo $home['nama'];?><br>
              <?php echo $home['instansi'];?></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form"  method="post" action="../proses?valid=sistem&method=user_daftar" onsubmit="return validasi_input(this)">

                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Username" aria-label="Name" name="username" required oninvalid="this.setCustomValidity('Masukan Username Terlebih Dahulu')" oninput="setCustomValidity('')" autocomplete="off">
                </div>

                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="NIP" aria-label="NIP" name="nip" required oninvalid="this.setCustomValidity('Masukan Nip Terlebih Dahulu')" oninput="setCustomValidity('')" autocomplete="off" onkeypress="return angka(event);">
                </div>

                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Nama" aria-label="nama" name="nama"  required oninvalid="this.setCustomValidity('Masukan Nama Terlebih Dahulu')" oninput="setCustomValidity('')" autocomplete="off">
                </div>
                ...
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Password" aria-label="Password" name="password"   required oninvalid="this.setCustomValidity('Masukan Password Terlebih Dahulu')" oninput="setCustomValidity('')" autocomplete="off">
                </div>

                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Ulangi Password" aria-label="Password" name="re_password"   required oninvalid="this.setCustomValidity('Masukan Password Terlebih Dahulu')" oninput="setCustomValidity('')" autocomplete="off">
                </div>

                <div class="text-center">
                  <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                </div>
                <p class="text-sm mt-3 mb-0">Sudah punya akun? <a href="http://localhost/simpeg_kejagung/" class="text-dark font-weight-bolder">Login</a></p>
              </form>
            </div>
          </div>
        </div>
